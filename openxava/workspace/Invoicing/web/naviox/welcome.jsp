...
<img id="logo_welcome" src="<%=request.getContextPath()%>/naviox/images/Regione_Marchebig.jpg"/>
...
<div class="ox-bottom-buttons">
	<input type="hidden">
	<input class="welcome-button" type="button" tabindex="1" onclick="window.location='m/SignIn'" value="<xava:label key='SignIn'/>">   
</div>
