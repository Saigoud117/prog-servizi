...
public class ProgBienUtils {
	...
	*/
	...
	public static void sendNotifyEmail(boolean isNew, boolean isWorking, boolean isClosed, boolean isReopened, String type, String creatore, String gestore, String seriale) throws AddressException, UnsupportedEncodingException, MessagingException {
		...
		if (isNew) {
			mailToCreator = "La sua richiesta di assistenza n. ".concat(seriale).concat(" è stata correttamente creata, la informeremo quando verrà visionata dall'ufficio competente.").concat("<br />").concat("<br />").concat("------").concat("<br />").concat("<br />").concat("<i>Non rispondere a questo messaggio, in quanto è stato generato automaticamente dal sistema e la casella di posta elettronica associata al mittente non è presidiata.</i>");
			mailToAdmin = "È stata creata una nuova richiesta di assisteza n. ".concat(seriale).concat(" , la invitiamo a prenderne visione su http://prog-servizi.regionemarche.intra/.").concat("<br />").concat("<br />").concat("------").concat("<br />").concat("<br />").concat("<i>Non rispondere a questo messaggio, in quanto è stato generato automaticamente dal sistema e la casella di posta elettronica associata al mittente non è presidiata.</i>");;
		}
		
		if (isWorking) {
			mailToCreator = "La sua richiesta di assistenza n. ".concat(seriale).concat(" è in elaborazione, le comunicheremo quando sarà chiusa.").concat("<br />").concat("<br />").concat("------").concat("<br />").concat("<br />").concat("<i>Non rispondere a questo messaggio, in quanto è stato generato automaticamente dal sistema e la casella di posta elettronica associata al mittente non è presidiata.</i>");
			mailToGestore = "Le è stata associata la richiesta di assistenza n. ".concat(seriale).concat(" ora in stato di elaborazione, la preghiamo di visionarla e dare risposta all'utente.").concat("<br />").concat("<br />").concat("------").concat("<br />").concat("<br />").concat("<i>Non rispondere a questo messaggio, in quanto è stato generato automaticamente dal sistema e la casella di posta elettronica associata al mittente non è presidiata.</i>");
		}
		
		if (isClosed) {
			mailToCreator = "La sua richiesta di assistenza n. ".concat(seriale).concat(" è stata chiusa, la invitiamo a consultare la risposta su http://prog-servizi.regionemarche.intra/.").concat("<br />").concat("<br />").concat("------").concat("<br />").concat("<br />").concat("<i>Non rispondere a questo messaggio, in quanto è stato generato automaticamente dal sistema e la casella di posta elettronica associata al mittente non è presidiata.</i>");
		}
		
		if (isReopened) {
			mailToAdmin = "La richiesta di assistenza n. ".concat(seriale).concat(" è stata riaperta, la invitiamo a prenderne visione su http://prog-servizi.regionemarche.intra/.").concat("<br />").concat("<br />").concat("------").concat("<br />").concat("<br />").concat("<i>Non rispondere a questo messaggio, in quanto è stato generato automaticamente dal sistema e la casella di posta elettronica associata al mittente non è presidiata.</i>");
		}
	...
	public static void sendNotifyEmailAbilitazione(String type, String creatore, String emailPrimaAbilitazione, String servizio, String descrizioneServizio) throws AddressException, UnsupportedEncodingException, MessagingException {
		...
		if (type.equals("Richiesta")) {
			...
			contentMittente = "Ha inviato una nuova richiesta di abilitazione per la piattaforma http://prog-servizi.regionemarche.intra. L'eventuale abilitazione verrà confermata tramite email.".concat("<br />").concat("<br />").concat("------").concat("<br />").concat("<br />").concat("<i>Non rispondere a questo messaggio, in quanto è stato generato automaticamente dal sistema e la casella di posta elettronica associata al mittente non è presidiata.</i>");
		}
		
		if (type.equals("Abilitazione")) {
			contentDestinatario = "La informiamo che è stato abilitato ad operare nella piattaforma http://prog-servizi.regionemarche.intra per la struttura ".concat(descrizioneServizio).concat(".").concat("<br />").concat("<br />").concat("------").concat("<br />").concat("<br />").concat("<i>Non rispondere a questo messaggio, in quanto è stato generato automaticamente dal sistema e la casella di posta elettronica associata al mittente non è presidiata.</i>");
		}
