...
public class CurrentUserServizioStrutturaRupFilter extends BaseContextFilter implements IFilter {
	 ...
	 private List<String> addStruttureServizio(String servizio) {
			...
			//Date data = new Date();
			//ho tolto il filtro per data poichè ci sono servizi che possono essere cambiati e devono essere comunque visualizzabili quando si richiama la procedura
