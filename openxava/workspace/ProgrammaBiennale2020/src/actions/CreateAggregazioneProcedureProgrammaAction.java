...
public class CreateAggregazioneProcedureProgrammaAction extends ViewBaseAction {
	public void execute() throws Exception { 
        ...
        ProcedureProgramma mainProc = new ProcedureProgramma();
        ...
        //nuovo accorpamento
        if (mainProc.getUltimopianoapprovato() != null)
        	copyProc.setCui(mainProc.getCui());
        ...
        */ 
        ...
        ArrayList<QuadroEconomicoProgramma> quadroEconomico = new ArrayList<QuadroEconomicoProgramma>();
	...
	protected void calculateCopeture(ProcedureProgramma ent, Collection<QuadroEconomicoProgramma> quadro) {
		...
		if (ent.getRicompreso() != null && ent.getRicompreso().toString().equals("No"))
		{
			for (QuadroEconomicoProgramma q: quadro)
	        {
