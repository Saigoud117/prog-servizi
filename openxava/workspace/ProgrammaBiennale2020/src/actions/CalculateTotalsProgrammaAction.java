...
public class CalculateTotalsProgrammaAction extends TabBaseAction {
	 @SuppressWarnings("unchecked")
	public void execute() throws Exception {
			Query query = XPersistence.getManager()
		        .createQuery("select p from ProcedureProgramma p where p.deleted = false and p.archived = false");
		    ArrayList<ProcedureProgramma> procedure = (ArrayList<ProcedureProgramma>) query.getResultList();
		    ...
		    for (ProcedureProgramma p: procedure) {
				...
				p.setCoperture(new ArrayList<CopertureProgramma>());
