 ...
 * Generated at: 2021-11-02 12:02:19 UTC
...
public final class selectColumns_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/xava/editors/../imports.jsp", Long.valueOf(1635154075190L));
    _jspx_dependants.put("/WEB-INF/openxava.tld", Long.valueOf(1635154076894L));
  }
...
for (Iterator it=tab.getColumnsToAdd().iterator(); it.hasNext();) { 
	...
	if (tab.isColumnsToAddUntilSecondLevel() && c > 20) break;
      ...
      // /xava/editors/selectColumns.jsp(53,2) name = cssStyle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if (tab.isColumnsToAddUntilSecondLevel()) {
      ...
      // /xava/editors/selectColumns.jsp(69,0) name = cssStyle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
