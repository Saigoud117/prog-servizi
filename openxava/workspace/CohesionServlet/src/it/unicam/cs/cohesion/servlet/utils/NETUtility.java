...
public class NETUtility {
	...
	public static byte[] sendHTTP(String url, String mode, String dataToSend, ArrayList<String[]> htmlHeaderList, boolean ignoreSSLSelfSigned, boolean ignoreSSLWrongCN) throws Exception{
		...
		if(connection.getResponseCode() >= 400)
			output = GeneralUtils.toByteArray(connection.getErrorStream());
		else
			output = GeneralUtils.toByteArray(connection.getInputStream());
	...
	private static ArrayList<String> safeSplitParameters(String parameters){
