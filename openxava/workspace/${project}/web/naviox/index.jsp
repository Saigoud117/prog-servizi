...
<body <%=XavaStyle.getBodyClass(request)%>>
	<div id="company_info">
		<img id="logo" src="<%=request.getContextPath()%>/naviox/images/Regione_Marchebig.png" /><div id="title_container">Sistema di rilevamento del fabbisogno finalizzato alla produzione del "Programma biennale degli acquisti di beni e Servizi"</div>
	</div>	
	<div id="main"> 
