...
public class SellerTest extends CustomizeListTestBase { 
	...
	public void testEmailNotificationsByModule_accessLog() throws Exception { 
		...
		assertEmailNotifications( // It fails with Java 8 because the order of changes that are from a Maps 
			...
			"MODIFIED: email=openxavatest1@getnada.com, user=admin, application=OpenXavaTest, module=Sellers, permalink=http://localhost:8080/OpenXavaTest/modules/Seller?detail=66, changes=<ul><li><b>Id of Level</b>:  --> A</li><li><b>Regions</b>: {} --> {1,3}</li></ul>",
			"MODIFIED: email=openxavatest2@getnada.com, user=admin, application=OpenXavaTest, module=Sellers, permalink=http://localhost:8080/OpenXavaTest/modules/Seller?detail=66, changes=<ul><li><b>Id of Level</b>:  --> A</li><li><b>Regions</b>: {} --> {1,3}</li></ul>",
			"MODIFIED: email=openxavatest1@getnada.com, user=admin, application=OpenXavaTest, module=Sellers, permalink=http://localhost:8080/OpenXavaTest/modules/Seller?detail=66, changes=<ul><li><b>Id of Level</b>: A --> C</li><li><b>Regions</b>: {1,3} --> {2}</li></ul>",
			"MODIFIED: email=openxavatest2@getnada.com, user=admin, application=OpenXavaTest, module=Sellers, permalink=http://localhost:8080/OpenXavaTest/modules/Seller?detail=66, changes=<ul><li><b>Id of Level</b>: A --> C</li><li><b>Regions</b>: {1,3} --> {2}</li></ul>",						
		...
		LogTrackerTestUtil.assertAccessLog(
			...
			"MODIFIED: user=admin, model=Seller, key={number=66}, changes=Id of Level:  --> A, Regions: {} --> {1,3}",
			"CONSULTED: user=admin, model=Seller, key={number=66}",
			"MODIFIED: user=admin, model=Seller, key={number=66}, changes=Id of Level: A --> C, Regions: {1,3} --> {2}",
			"CONSULTED: user=admin, model=Seller, key={number=66}",
