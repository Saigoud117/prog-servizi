...
public class Carrier implements java.io.Serializable, org.openxava.test.model.ICarrier {	
	...
	private java.util.Collection getFellowCarriers_hibernate() throws RemoteException {
		org.hibernate.Query query = org.openxava.hibernate.XHibernate.getSession().createQuery("from Carrier as o where 				o.warehouse.zoneNumber = ? AND 				o.warehouse.number = ? AND 				NOT (o.number = ?)			 order by o.number");
