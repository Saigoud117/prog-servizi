...
<head>
	<link rel="shortcut icon" href="<%=request.getContextPath()%>/naviox/images/favicon.ico">
	<img id="logo_welcome" src="<%=request.getContextPath()%>/naviox/images/Regione_Marchebig.png"/>
	<title><%=title%></title>
...
<div class="ox-bottom-buttons">
	<input type="hidden">
	<a class="welcome-link" href="\CohesionServlet\login.jsp?ReturnUrl=../ProgrammaBiennale2020/naviox/signInCohesion.jsp"><xava:label key='SignInCohesion'/></a>
</div>
<input type="button" class="button-small" tabindex="1" onclick="window.location='m/SignIn'" value="<xava:label key='SignIn'/>">   
</body>
